...
For your local environment, you can override the surrogate key header limit, which defaults to 0 bytes, by adding the following line to your site's settings.php file and adjusting the value as needed. Note that the maximum value is capped at 25,000 bytes.
